...
максимальное время работы для входов данного размера. \\[0.2cm]
\textbf{Время работы алгоритма в среднем (средняя сложность)} - 
максимальное время работы для входов данного размера.\\[0.2cm]
\textbf{Время работы алгоритма в случайном среднем (рандомизированная сложность)} - 
максимальное время работы для входов данного размера.\\[0.2cm]
\textbf{Время работы алгоритма в среднем (ароматизированная сложность)} - 
